...
function highlightSelection(){
  ...
  checkInInput.value  = start ? start.toLocaleDateString('en-GB', opts) : 'Add dates';
  checkOutInput.value = end ? end.toLocaleDateString('en-GB', opts) : 'Add dates';
