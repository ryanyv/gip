...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'email', 'first_name', 'last_name', 'role', 'position', 'is_superuser', 'profile_photo_tag')
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('first_name', 'last_name', 'email', 'profile_photo', 'position')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'first_name', 'last_name', 'role', 'position', 'profile_photo', 'password1', 'password2', 'is_active', 'is_staff', 'is_superuser', 'groups', 'user_permissions'),
        }),
    )
